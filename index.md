...
venue: Helmholtz Information & Data Science Academy (HIDA)       # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
longitude: "11"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "April 24-25, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "09:00 - 13:00 CET"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-09-24      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-09-25        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: [ "Daria Romanovskaia"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
collaborative_notes: https://pad.carpentries.org/Kickstart_R_(HIDA%2C_April)  https://pad.carpentries.org/Kickstart_R_HIDA_September_2026 # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
